...
if os.environ.get('VERCEL') == '1':
    TMP_DB = '/tmp/campus_erp.db'
    ORIG_DB = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'campus_erp.db')
    if not os.path.exists(TMP_DB) and os.path.exists(ORIG_DB):
        shutil.copy2(ORIG_DB, TMP_DB)
    DB_PATH = TMP_DB
else:
    DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'campus_erp.db')
